...
# Role/position
role: Gaussian Process based Stochastic Model Predictive Control of Industrial Penicillin Production
...
education:
  courses:
    - course: MSc Process, Energy and Environmental System Engineering
      institution: TU Berlin / BIFOLD
      year: 2021
    - course: BSc in Chemical Engineering
      institution: Polytechnic Tehran (Amir Kabir University)
      year: 2017
...
social:
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/psemnani/
  - icon: github
    icon_pack: fab
    link: https://github.com/psemnani
  - icon: laptop
    icon_pack: fas
    link: https://psemnani.github.io/
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=rWFoXBYAAAAJ&hl=en
